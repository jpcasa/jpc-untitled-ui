...
interface LinkProps
	extends CommonProps, DetailedHTMLProps<Omit<AnchorHTMLAttributes<HTMLAnchorElement>, 'color'>, HTMLAnchorElement> {}
...
export const SocialButton = ({
	...
	const socialLabels: Record<string, string> = {
		...
		figma: 'Open in Figma',
		dribble: 'View on Dribbble',
	}
	const effectiveAriaLabel = isIconOnly ? ariaLabel || socialLabels[social] : ariaLabel
		...
		>
			<Logo
				...
				colorful={
					...
					(theme === 'color' &&
						(social === 'google' || social === 'facebook' || social === 'figma' || social === 'dribble')) ||
					undefined
				}
			/>
